...
/**
 * ==============================================================
 * Description: 文本的不同部分显示，例如前景色，背景色，下划线等
 * <p>
 * Created by leonyr on 2019/7/29
 * (C) Copyright LeonyR Corporation 2014 All Rights Reserved.
 * ==============================================================
 */
public class SpanUtil extends SpannableStringBuilder {
    ...
    public SpanUtil(CharSequence text) {
        super(text);
    }

    public <T extends CharacterStyle> SpanUtil(CharSequence text, T... spans) {
        super(text);
    ...
    public <T extends CharacterStyle> SpanUtil(CharSequence text, T span) {
        super(text);
     ...
     * @return this {@code SpanUtil}.
     */
    public <T extends CharacterStyle> SpanUtil append(CharSequence text, T... spans) {
        append(text);
        for (Object span : spans) {
    ...
    public <T extends CharacterStyle> SpanUtil append(CharSequence text, T span) {
        append(text);
        setSpan(span, length() - text.length(), length());
        return this;
    }
     ...
     * @return this {@code SpanUtil}.
     */
    public SpanUtil append(CharSequence text, ImageSpan imageSpan) {
        text = "." + text;
        append(text);
    ...
    /**
     * @deprecated use {@link #append(java.lang.CharSequence text)}
     */
    @Deprecated
     ...
     * @return {@code SpanUtil}.
     */
    public SpanUtil findAndSpan(CharSequence textToSpan, GetSpan getSpan) {
        int lastIndex = 0;
        while (lastIndex != -1) {
    ...
    /**
     * Sets span objects to the text. This is more efficient than creating a new instance of SpanUtil
     * or SpannableStringBuilder.
     *
     * @return {@code SpannableString}.
     */
    public static <T extends CharacterStyle> SpannableString spanText(CharSequence text, T... spans) {
